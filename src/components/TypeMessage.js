...
class TypeMessage extends Component {
    render() {
        return (
            <div className="absolute bottom-0 flex items-center py-3 w-full px-2" style={{ 'background' : '#f0f0f0'}}>
                <svg className="mx-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
                    <path fill="#919191"
                ...
                <input type="text" placeholder="Type a message" className="placeholder-black     w-full py-3 rounded-full pl-4"/>
                <svg className="mx-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
                    <path fill="#919191"
