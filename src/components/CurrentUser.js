...
class CurrentUser extends Component {
    render() {
        return (
            <div className="flex px-5 py-3 items-center shadow-lg absolute w-full top-0 z-10" style={{'background': '#ededed'}}>
                <img className="w-10 rounded-full" src={avatar} alt=""/>
                <div className="ml-4 flex items-center justify-between w-full border-b">
                    <h1 className="text-lg">Rohit CR</h1>
                    <div className="flex" style={{ 'color' : '#919191' }}>
