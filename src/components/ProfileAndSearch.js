    ...
    render() {
        return (
            <div className="flex flex-col">
                <div className="flex px-5 py-3 justify-between items-center border-r-2" style={{'background': '#ededed'}}>
                    <div id="avatar">
                        <img className="w-10 rounded-full" src={avatar} alt=""/>
                    </div>
                    <div id="options" className="flex" style={{'color': '#919191'}}>
                        <svg className="mx-4" id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6"
                        ...
                        <svg className="mx-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                             height="24">
                            <path fill="currentColor"
                ...
                <div id="search" className="px-4 py-2" style={{'background': '#f7f7f7'}}>
                    <div className="relative items-center">
                        <svg className="absolute mt-2 ml-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                             width="24" height="24" style={{'color': 'rgba(0,0,0,0.3)'}}>
                            <path fill="currentColor"
                        ...
                        <input className="w-full rounded-full py-2 px-16 placeholder-black"
